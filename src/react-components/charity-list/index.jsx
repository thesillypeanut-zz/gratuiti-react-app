            ...
            <ul className="charity-list__list">
                <li className="charity-list__item">
                    <CharityCard
                        ...
                        details="AKFC's work covers two core lines of activity: programming related to international development,
                        and the acquisition and development of properties used for charitable purposes. Both of these
                        areas are supported by separate funding streams. It also offers an International Fellowship
                        Program for Young Canadians and other programs enabling Canadians to serve in the developming
                        world, and a robust public engagement and professional learning program to raise awareness and
                        encourage discussion about Canada's role in an interdependent world."
                    ...
                    <section className="charity-list__details">
                        ...
                        <div className="charity-list__detail-block center">
                            <h2>Charity Data</h2>
                            <img src="/images/AKFC.png" />
                        </div>
                        <div className="charity-list__detail-block">
                            <h2>Projects</h2>
                        </div>
                ...
                <li className="charity-list__item">
                    <CharityCard
                        ...
                        details="PROVIDING LODGE SERVICES FOR SENIORS IN OUR SERVICE AREA"
                ...
                <li className="charity-list__item">
                    <CharityCard
                        ...
                        blurb="ICYA provides a safe, active and nurturing environment for children and youth, many of whom
                        experience poverty, abuse and neglect."
                        details="The Bridge Drop-in Centre-Staff and volunteers role model and interact with inner city youth.
                ...
                <li className="charity-list__item">
                    <CharityCard
                        ...
                        details="Projects: One on one literacy/numeracy training for adults. Small group literacy classes for adults and
